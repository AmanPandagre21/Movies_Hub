...
const endPoint = movies_and_tv_apis.discover("tv", 1);
...
const tv = ({ data }) => {
  ...
  const pageHandler = () => {
    ...
    setDefaultEndPoint((prev) => {
      return {
        defaultendpoint: movies_and_tv_apis.discover("tv", page),
        category: "page",
      };
    });
  };
  ...
  const handleOnSubmitSearch = (e) => {
    ...
    const searchPoint = movies_and_tv_apis.search("tv", value, 1);
    setDefaultEndPoint((prev) => {
